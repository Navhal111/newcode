...
//                            toast(mainJson.toString()
                            ...
                            while(i < mainJson.length()){
                                if(mainJson.getJSONObject(i)["packeg"] != "pistalix.dslrcamera.dslrcamerahd"){
        ...
        rateus.setOnClickListener{
            try {
                ...
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=pistalix.dslrcamera.dslrcamerahd")))
            }
        }
    }
