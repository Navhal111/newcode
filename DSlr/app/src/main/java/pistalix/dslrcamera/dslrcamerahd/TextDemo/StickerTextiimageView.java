...
public class StickerTextiimageView extends DemoStickerView {

    private String owner_id;
    private ImageView iv_main;

    public StickerTextiimageView(Context context, OnTouchSticker onTouchSticker) {
        super(context, onTouchSticker);
    }

    public StickerTextiimageView(Context context, AttributeSet attrs, OnTouchSticker onTouchSticker) {
        super(context, attrs, onTouchSticker);
    }

    public StickerTextiimageView(Context context, AttributeSet attrs, int defStyle, OnTouchSticker onTouchSticker) {
