package pistalix.echoeffect.photoeditor
...
//                            toast(mainJson.toString()
                            ...
                            while(i < mainJson.length()){
                                if(mainJson.getJSONObject(i)["packeg"] != "pistalix.echoeffect.photoeditor"){
        ...
        rateus.setOnClickListener{
            try {
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=pistalix.dslrcamera.dslrcamerahd")))
            } catch (anfe: android.content.ActivityNotFoundException) {
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=pistalix.echoeffect.photoeditor")))
            }
        }
    }
